...
const ObjectSearchSchema = {
  objectType: z
    .string()
    .describe(
      `The type of HubSpot object to search. Valid values include: ${HUBSPOT_OBJECT_TYPES.join(
        ", "
...
const ToolDefinition = {
  ...
  `,
  inputSchema: ObjectSearchSchema,
  annotations: {
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error searching HubSpot ${args.objectType}: ${
