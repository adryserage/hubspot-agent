...
const CreatePropertySchema = {
  objectType: z
    .string()
    .describe(
      `The type of HubSpot object to create the property for. Valid values include: ${HUBSPOT_OBJECT_TYPES.join(
        ", "
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error creating HubSpot property for ${args.objectType}: ${
