...
const BatchUpdateObjectsSchema = {
  objectType: z
    .string()
    .describe(
      `The type of HubSpot object to update. Valid values include: ${HUBSPOT_OBJECT_TYPES.join(
        ", "
...
const ToolDefinition = {
  ...
  `,
  inputSchema: BatchUpdateObjectsSchema,
  annotations: {
...
export const batchUpdateObjectsTool = {
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error batch updating HubSpot objects: ${
