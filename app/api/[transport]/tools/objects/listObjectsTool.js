...
const ObjectListSchema = {
  objectType: z
    .string()
    .describe(
      `The type of HubSpot object to list. Valid values include: ${HUBSPOT_OBJECT_TYPES.join(
        ", "
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error listing HubSpot ${args.objectType}: ${
