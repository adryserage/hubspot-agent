...
const AssociationsListSchema = {
  objectType: z
    .string()
    .describe(
      `The type of HubSpot object to get associations from. Valid values include: ${HUBSPOT_OBJECT_TYPES.join(
        ", "
  ...
  toObjectType: z
    .string()
    .describe(
      `The type of HubSpot object to get associations to. Valid values include: ${HUBSPOT_OBJECT_TYPES.join(
        ", "
      )}. For custom objects, use the hubspot-get-schemas tool to get the objectType.`
    ),
  after: z
...
const ToolDefinition = {
  ...
  `,
  inputSchema: AssociationsListSchema,
  annotations: {
...
export const listAssociationsTool = {
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error retrieving HubSpot associations: ${
