...
const BatchCreateObjectsSchema = {
  objectType: z
    .string()
    .describe(
      `The type of HubSpot object to create. Valid values include: ${HUBSPOT_OBJECT_TYPES.join(
        ", "
...
const ToolDefinition = {
  ...
  `,
  inputSchema: BatchCreateObjectsSchema,
  annotations: {
...
export const batchCreateObjectsTool = {
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error batch creating HubSpot objects. : ${
