...
const BatchReadObjectsSchema = {
  objectType: z
    .string()
    .describe(
      `The type of HubSpot object to read. Valid values include: ${HUBSPOT_OBJECT_TYPES.join(
        ", "
...
const ToolDefinition = {
  ...
  `,
  inputSchema: BatchReadObjectsSchema,
  annotations: {
...
export const batchReadObjectsTool = {
    ...
    try {
      ...
      return {
        content: [
          {
            type: "text",
            text: `Error batch reading HubSpot objects: ${
